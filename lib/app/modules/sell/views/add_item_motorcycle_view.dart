...
import '../widget/motorcycle/motorcycle_form_one.dart';
import '../widget/motorcycle/motorcycle_form_two.dart';
import '../widget/step_clip_path.dart';

class AddItemMotorcycleView extends StatefulWidget {
  const AddItemMotorcycleView({super.key});

  @override
  _AddItemMotorcycleViewState createState() => _AddItemMotorcycleViewState();
}

class _AddItemMotorcycleViewState extends State<AddItemMotorcycleView> {
  ...
  Widget _buildStepContent(int stepIndex) {
    switch (stepIndex) {
      case 0:
        return MotorcycleFormOne();
      case 1:
        return MotorcycleFormTwo();
      default:
