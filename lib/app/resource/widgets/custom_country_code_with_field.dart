...
class CustomCountryCodeWithField extends StatefulWidget {
  final String hintText;
  final TextEditingController? controller;
  CustomCountryCodeWithField({
    Key? key,
  ...
  @override
  State<CustomCountryCodeWithField> createState() => _CustomCountryCodeWithFieldState();
}

class _CustomCountryCodeWithFieldState extends State<CustomCountryCodeWithField> {
