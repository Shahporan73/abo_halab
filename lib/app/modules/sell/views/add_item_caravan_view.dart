...
class AddItemCaravanView extends StatefulWidget {
  const AddItemCaravanView({super.key});

  @override
  _AddItemCaravanViewState createState() => _AddItemCaravanViewState();
}

class _AddItemCaravanViewState extends State<AddItemCaravanView> {
  ...
  Widget _buildStepContent(int stepIndex) {
    switch (stepIndex) {
      case 0:
        return CaravanFormOne();
      case 1:
        return CaravanFormTwo();
      default:
